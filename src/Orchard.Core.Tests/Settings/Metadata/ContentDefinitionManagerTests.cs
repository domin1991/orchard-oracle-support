...
namespace Orchard.Core.Tests.Settings.Metadata {
    ...
    public class ContentDefinitionManagerTests {
        ...
        public void Init() {
            ...
            foreach (var killType in new[] { typeof(ContentTypeDefinitionRecord), typeof(ContentPartDefinitionRecord), typeof(ContentFieldDefRecord) }) {
