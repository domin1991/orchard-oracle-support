...
namespace Orchard.Tests.ContentManagement {
    ...
    public class DefaultContentManagerTests {
        ...
        private ContentItemRecord CreateModelRecord(string contentType) {
            ...
            contentItemVersionRepository.Create(new ContentItemVersionRecord { ContentItemRecord = modelRecord, Latest = true, Published = true, Number_ = 1 });
        ...
        public void InitialVersionShouldBeOne() {
            ...
            Assert.That(gamma1.ContentItem.VersionRecord.Number_, Is.EqualTo(1));
            ...
            Assert.That(gamma2.ContentItem.VersionRecord.Number_, Is.EqualTo(1));
