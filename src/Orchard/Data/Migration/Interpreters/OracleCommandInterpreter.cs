...
namespace Orchard.Data.Migration.Interpreters
{
        ...
        ICommandInterpreter<DropForeignKeyCommand>
    {
        ...
        public string[] CreateStatements(CreateTableCommand command)
        {
            ...
            if (primaryKeys.Any())
            {
                builder.Append(" EXECUTE immediate 'ALTER TABLE ")
                    .Append(_dialect.QuoteForTableName(command.Name))
                    .Append(" ADD CONSTRAINT ")
                    .Append(OracleNameService.PrimaryKey(command.Name))
        ...
        private void Visit(StringBuilder builder, CreateColumnCommand command)
        {
            ...
            {
                {
                    builder.Append(GetSqlTypeName(command.DbType, command.Length, command.Precision, command.Scale));
                }
            }
        ...
        private string GetSqlTypeName(DbType dbType, int? length, byte precision, byte scale)
        {
